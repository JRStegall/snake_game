...
function control(e){
    if(e.keycode === 39){
        ...
        direction = -width; //IF WE PRESS THE UP ARROW, THE SNAME WILL GO TEN DIVS UP
    } else if (e.keycode === 37){
        direction = -1 //THE SNAKE WILL GO LEFT ONE DIV
    } else if (e.keycode === 40) {
        direction = +width; //THE SNAKE HEAD WILL INSTANTLY APPEAR TEN DIVS BELOW FROM CURRENT DIV
    }
};
